...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
                    ...
                    ->addColumn('action', function ($data) {
                        return '<div class="" role="group">
                                    ...
                                    <a class="btn btn-sm btn-danger" style="cursor:pointer" 
                                       href="'.route('customer.delete', [$data->id]).'" 
            ...
            return view('dashboard.pages.people.customer.index');
    ...
    {
        try {
            return view('dashboard.pages.people.customer.create');
        } catch (\Exception $exception) {
            return redirect()->back()->with('error', $exception->getMessage());
        }
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('dashboard.pages.people.customer.edit', compact('data'));

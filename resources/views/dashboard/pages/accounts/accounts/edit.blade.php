...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">edit new account</li>
    </ol>
@endsection
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h5 class="box-title"><b>EDIT ACCOUNT</b></h5>
            <a href="{{route('accounts.index')}}" id="add_new" style="float: right" class="btn btn-sm btn-grad">Account
                List
            </a>
        </div>
        <div class="box-body">
            <form id="form" action="{{route('accounts.update', $data->id)}}" method="post">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class=" col-md-4">
                        ...
                        <select required name="type" id="type" class="select2 form-control @error('type') is-invalid @enderror">
                            ...
                            <option @if($data->type == 1) selected @endif value="1">Petty cash</option>
                            <option @if($data->type == 2) selected @endif value="2">Bank</option>
                        </select>
                        @error('type')
                    ...
                    <div class=" col-md-4">
                        ...
                        <input id="opening_balance" type="number"
                               ...
                               name="opening_balance" value="{{ $data->opening_balance }}" required>
                ...
                <div class="row" id="bank-area" style="margin-top: 4px">
                    <div class=" col-md-4">
                        ...
                        <input id="bank" type="number" class="form-control @error('bank') is-invalid @enderror"
                               name="bank" value="{{ $data->bank }}" required>
                    ...
                    <div class=" col-md-4">
                        ...
                        <input id="branch" type="text" class="form-control @error('branch') is-invalid @enderror"
                               name="branch" value="{{ $data->branch}}" required>
                    ...
                    <div class=" col-md-4">
                        ...
                        <input id="account_no" type="text"
                               ...
                               value="{{ $data->account_no }}" required>

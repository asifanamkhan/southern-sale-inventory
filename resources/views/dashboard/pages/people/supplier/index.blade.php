...
@section('content-header')
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-pie-chart"></i> Supplier</a></li>
...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h5 class="box-title"><b>SUPPLIER LIST</b></h5>
            <a href="{{route('supplier.create')}}" id="add_new" style="float: right" class="btn btn-sm btn-grad">Add New Supplier</a>
        </div>
        <div class="box-body">

...
@section('content-header')
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-pie-chart"></i> Product</a></li>
...
@section('content')
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <form id="create_form" action="{{route('products-categories.store')}}" method="post">
                        @csrf
                        <div class="row">
    ...
    <div class="modal fade bd-example-modal-lg" id="editModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <form id="edit_form" action="{{route('products-categories.update')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="">Name</label><span style="font-weight: bold; color: red"> *</span>
...
@section('js')
    ...
    <script>
        ...
        function catEdit(id) {
            let name = $('#product-cat-' + id).attr('cat_name');
            let description = $('#product-cat-' + id).attr('cat_desc');

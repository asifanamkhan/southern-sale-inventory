...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h5 class="box-title"><b>EDIT PRODUCT</b></h5>
            ...
            <form id="form" action="{{route('products.update', $product->id)}}" method="post">
                    ...
                    <div class=" col-md-4">
                        ...
                        <select name="warehouse_id" id="warehouse_id" class="select2 form-control @error('warehouse_id') is-invalid @enderror">
                            ...
                            @foreach($warehouses as $warehouse)
                                <option @if($warehouse->id == $product->warehouse_id) selected @endif value="{{$warehouse->id}}">{{$warehouse->name}}</option>
                            @endforeach
                        </select>
                        @error('warehouse_id')
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="row" style="margin-top: 4px">
                    <div class=" col-md-4">
                        ...
                        <input id="stock" type="number" class="form-control @error('stock') is-invalid @enderror" name="stock" value="{{ $product->stock ?? 0 }}" required>
                    ...
                    <div class=" col-md-4">
                        ...
                        <input id="purchase_price" type="number" class="form-control @error('purchase_price') is-invalid @enderror" name="purchase_price" value="{{ $product->purchase_price ?? 0 }}" required>
                    ...
                    <div class=" col-md-4">
                        ...
                        <input id="sale_price" type="text" class="form-control @error('sale_price') is-invalid @enderror" name="sale_price" value="{{ $product->sale_price ?? 0 }}" required>

...
@section('content-header')
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-pie-chart"></i> Designation</a></li>
...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h5 class="box-title"><b>DESIGNATION LIST</b></h5>
            <button id="add_new" style="float: right" class="btn btn-sm btn-grad">Add New Designation</button>
        </div>
        <div class="box-body">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <form id="create_form" action="{{route('designation.store')}}" method="post">
                        @csrf
                        <div class="row">
    ...
    <div class="modal fade bd-example-modal-lg" id="editModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <form id="edit_form" action="{{route('designation.update')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="">Name</label><span style="font-weight: bold; color: red"> *</span>
                            ...
                            <input type="hidden" id="edit_id" name="designation_id">
                            <div class="form-group col-md-12">
                                <label for="">Description</label>
...
@section('js')
    ...
    <script>
        ...
        function catEdit(id) {
            let name = $('#designation-' + id).attr('cat_name');
            let description = $('#designation-' + id).attr('cat_desc');

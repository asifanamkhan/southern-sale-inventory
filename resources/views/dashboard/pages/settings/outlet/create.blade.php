...
@section('content-header')
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-pie-chart"></i> Outlet</a></li>
...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h5 class="box-title"><b>ADD NEW OUTLET</b></h5>
            <a href="{{route('outlet.index')}}" id="add_new" style="float: right" class="btn btn-sm btn-grad">outlet List
                </a>
        </div>
        <div class="box-body">
            <form id="form" action="{{route('outlet.store')}}" method="post">
                @csrf
                <div class="row">
                    <div class=" col-md-4">
                        <label for="name" class="col-form-label text-md-end">Outlet Name</label><span style="font-weight: bold; color: red"> *</span>

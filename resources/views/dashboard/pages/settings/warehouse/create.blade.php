...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">add new warehouse</li>
    </ol>
@endsection
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h5 class="box-title"><b>ADD NEW WAREHOUSE</b></h5>
            <a href="{{route('warehouse.index')}}" id="add_new" style="float: right" class="btn btn-sm btn-grad">warehouse List
                </a>
        </div>
        <div class="box-body">
            <form id="form" action="{{route('warehouse.store')}}" method="post">
                @csrf
                <div class="row">
                    <div class=" col-md-4">
                        <label for="name" class="col-form-label text-md-end">Warehouse Name</label><span style="font-weight: bold; color: red"> *</span>
